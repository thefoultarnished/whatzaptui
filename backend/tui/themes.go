...
var (
	...
	Nord = Theme{
		...
		FileTag:                  "#7C9D6A", // darkened Aurora green for contrast
		StickerTag:               "#B48EAD", // purple
		ContactTag:               "#5B9098", // darkened frost teal
		...
		ButtonInk:                "#ECEFF4",
		TagInk:                   "#ECEFF4",
		Cursor:                   "#5E81AC", // brand blue cursor
		QRLight:                  "#ECEFF4",
		QRDark:                   "#2E3440",
		...
		MessageSelectedBg:        "#D2E2F5",
		MediaTokenBg:             "#5E81AC", // frost blue
		MediaTokenPulseBg:        "#8FB3D9", // lighter frost blue pulse
		Background:               "#BBE9FC", // very light blue
	}
